...
<body class="subpage">
    ...
    <section class="wrapper special" id="one">
        <div class="inner">
            <header class="major">
                <h2>Bebidas</h2>
                <p>En este apartado puedes ver los datos por cada una de nuestras Bebidas</p>
                <?php
                include("Conexion.php");
                $link=Conectarse();

                $var_consulta= "SELECT * FROM bebidas";
                echo  '<img src= "../Menu/images/banner3.jpg" height="350" />';
                $var_query = $link->query($var_consulta);

                echo "<table align =center border=1 bgcolor=#FFDE9B>";
                  echo"<tr>";
                  echo "<td> No. Platillo </td>";
                  echo "<td> Nombre Bebida </td>";
                  ...
                  echo "</table>";
                  echo "<a href='consultaEntrada.php' class='button'>Entradas</a>";
    ...
    <footer>
        <a href="opcionesBebidas.html" class="button">Regresar</a>
