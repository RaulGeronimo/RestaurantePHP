...
<body class="subpage">
    ...
    <!-- form -->
    <form action="buscarBebida.php" method="POST">
        <div class="buscar">
    ...
    <section id="one" class="wrapper special">
        <div class="inner">
            <header class="major">
                <h2>Bebidas</h2>
                <p>En este apartado puedes buscar cada uno de nuestras Bebidas</p>
                <?php
                  include("Conexion.php");
                  $link=Conectarse();
                  $codigo = $_POST['codigo'];
                  $var_consulta= "SELECT * FROM bebidas WHERE codigo = $codigo";
