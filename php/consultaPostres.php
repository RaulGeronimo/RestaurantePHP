...
<body class="subpage">
    ...
    <section class="wrapper special" id="one">
        <div class="inner">
            <header class="major">
                <h2>Postres</h2>
                <p>En este apartado puedes ver los datos por cada uno de nuestros platillo que servimos de Postres</p>
                <?php
                include("Conexion.php");
                $link=Conectarse();

                $var_consulta= "SELECT * FROM postres";
                echo  '<img src= "../Menu/images/banner2.jpg" height="350" />';
